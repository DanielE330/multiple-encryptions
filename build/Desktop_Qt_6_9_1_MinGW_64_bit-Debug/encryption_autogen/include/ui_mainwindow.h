...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget_2->setGeometry(QRect(0, 0, 141, 176));
        ...
        to_cesar = new QRadioButton(centralwidget);
        to_cesar->setObjectName("to_cesar");
        to_cesar->setGeometry(QRect(250, 30, 81, 16));
        to_aes_256 = new QRadioButton(centralwidget);
        to_aes_256->setObjectName("to_aes_256");
        to_aes_256->setGeometry(QRect(250, 50, 68, 16));
        MainWindow->setCentralWidget(centralwidget);
        menubar = new QMenuBar(MainWindow);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 416, 18));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        to_aes_256->setText(QCoreApplication::translate("MainWindow", "aes-256", nullptr));
    } // retranslateUi
